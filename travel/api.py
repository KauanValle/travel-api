...
@travel_router.post('/', response={201: dict, 500: dict}, tags=["Travel"])
...
@travel_router.get('/all', response={200: dict}, tags=["Travel"])
...
@travel_router.get('/{travel_id}', response={200: dict, 404: dict, 500: dict}, tags=["Travel"])
@handle_exceptions
...
@travel_router.put('/{travel_id}', response={200: dict, 404: dict, 500: dict}, tags=["Travel"])
@handle_exceptions
...
@travel_router.delete('/{travel_id}', response={200: dict, 404: dict, 500: dict}, tags=["Travel"])
@handle_exceptions
...
@travel_router.post('/finish-travel/{travel_id}', response={200: dict, 404: dict, 500: dict}, tags=["Travel"])
@handle_exceptions
